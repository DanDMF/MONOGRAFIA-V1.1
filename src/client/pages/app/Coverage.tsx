...
const ROWS: [string, string, string][] = [
  ...
  ["Documento académico DOCX/PDF (perfil APA de estudante) e exportação BibTeX/RIS/CSL-JSON", "Implementado e verificado (testes + páginas do PDF inspecionadas)", "ok"],
